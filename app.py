...
catalogo = Catalogo(host='davidcc.mysql.pythonanywhere-services.com', user='davidcc', password='basededatos', database='davidcc$miapp')
...
RUTA_DESTINO = '/home/davidcc/mysite/static/imagenes'
